...
const DONE_STATUSES = new Set(['canceled', 'cancelled', 'completed', 'done']);
...
function getTaskNotesApi(ctx: DashboardWidgetContext): null | TaskNotesApi {
...
function taskFile(task: TaskInfo, ctx: DashboardWidgetContext): null | TFile {
