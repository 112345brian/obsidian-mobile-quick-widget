...
interface SlotPos { clock: string; left: number; top: number }
const SLOTS: SlotPos[] = [
  { clock: '12', left: 170, top: 60 },
  { clock: '2', left: 265, top: 115 },
  { clock: '4', left: 265, top: 225 },
  { clock: '6', left: 170, top: 280 },
  { clock: '8', left: 75, top: 225 },
  { clock: '10', left: 75, top: 115 }
];
...
export class RadialMenuV3Modal extends Modal {
  ...
  private renderSlot(wrap: HTMLElement, pos: SlotPos, data: SlotData | undefined): void {
    ...
    if (!data?.onTap) { btn.addClass('qw-radial-btn--ghost'); }
